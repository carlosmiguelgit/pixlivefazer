...
export const RESPOSTAS_AGENUARDAR: { texto: string; faixa: 'baixa' | 'alta'; genero: 'female' | 'male' }[] = [
  ...
  { texto: "obrigada eu acreditei em voce o tempo todo, amém", faixa: 'baixa', genero: 'female' },
  ...
  { texto: "moço to chorando de tanta gratidao", faixa: 'alta', genero: 'female' },
  { texto: "obrigada de coracao voce nao imagina o quanto", faixa: 'alta', genero: 'female' },
  { texto: "não esperava nada e chegou", faixa: 'alta', genero: 'female' },
  { texto: "to sem acreditar isso e real", faixa: 'alta', genero: 'female' },
  { texto: "obrigada demais ja tinha perdido as esperanças", faixa: 'alta', genero: 'female' },
  { texto: "isso mudou minha vida obrigada", faixa: 'alta', genero: 'female' },
  ...
  { texto: "achava que era enrolação mas caiu certinho", faixa: 'alta', genero: 'male' },
  { texto: "to tremendo achei que tinha perdido tudo", faixa: 'alta', genero: 'male' },
  { texto: "ja tinha desistido mas vlw pela confiança", faixa: 'alta', genero: 'male' },
  { texto: "mano to em choque veio de verdade", faixa: 'alta', genero: 'male' },
  { texto: "obrigado de coracao tava sem esperança nenhuma", faixa: 'alta', genero: 'male' },
  { texto: "não esperava mais nada e caiu", faixa: 'alta', genero: 'male' },
  { texto: "achei que era cilada mas veio mesmo", faixa: 'alta', genero: 'male' },
  { texto: "to incrédulo isso e real", faixa: 'alta', genero: 'male' },
  { texto: "obrigado demais ja tava fudido", faixa: 'alta', genero: 'male' },
  { texto: "chegou certinho mano vlw", faixa: 'alta', genero: 'male' },
  { texto: "isso e uma benção na minha vida", faixa: 'alta', genero: 'male' },
];
