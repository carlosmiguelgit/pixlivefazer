...
export const RESPOSTAS_AGENUARDAR: { texto: string; faixa: 'baixa' | 'alta'; genero: 'female' | 'male' }[] = [
  ...
  { texto: "ja tinha caido em golpe antes achei que era mais um", faixa: 'alta', genero: 'male' },
  { texto: "meu deus funcionou mesmo to chocado", faixa: 'alta', genero: 'male' },
  { texto: "pensei que era furada mas chegou certinho", faixa: 'alta', genero: 'male' },
  { texto: "to tremendo achei que ia perder mais dinheiro", faixa: 'alta', genero: 'male' },
  { texto: "ja tinha desistido de acreditar nesse tipo de coisa", faixa: 'alta', genero: 'male' },
  { texto: "chegou mesmo to choquee", faixa: 'alta', genero: 'male' },
  { texto: "obrigado de coracao ja tinha levado golpe antes", faixa: 'alta', genero: 'male' },
  { texto: "não esperava nada e chegou", faixa: 'alta', genero: 'male' },
  { texto: "pensei que era mais um golpe mas funcionou", faixa: 'alta', genero: 'male' },
  { texto: "to sem acreditar chegou mesmo", faixa: 'alta', genero: 'male' },
  { texto: "obrigado demais ja tinha perdido a esperança", faixa: 'alta', genero: 'male' },
